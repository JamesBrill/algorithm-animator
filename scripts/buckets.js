...
buckets.Heap.prototype.updateItem = function(item) {
  var index = buckets.arrays.indexOf(this.data,item,null);
  this.siftUp(index);
}
...
buckets.PriorityQueue.prototype.updateItem = function(item) {
